...
// Get existing gremlin database
resource gremlinDb 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases@2025-05-01-preview' existing = {
  name: gremlinDatabaseName
  parent: gremlinAccount
}

// Get existing gremlin graph
resource gremlinGraph 'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs@2025-05-01-preview' existing = {
