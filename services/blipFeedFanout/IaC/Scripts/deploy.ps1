...
$fedCredName = "blipfeedfanout-fed-cred"  # Unique name
...
az identity federated-credential create `
    ...
    --resource-group $aksRG `
    --issuer $issuerUrl `
    --subject system:serviceaccount:blipfeedfanout:blipfeedfanout-sa `
